   ...
   <a href="adminDetails.php">Admin Dashbord</a>
    ...
    <h5 class="text-danger"><?php echo $err_db;?></h5>
		...
		<fieldset>
            ...
            <h1 align="center"><u>Edit Account for People</u></h1>
		<table align="center">
        ...
        <td><input id="id" type="hidden" name="id" value="<?php echo $n["id"]; ?>"  placeholder=""> </td>
        </tr>
			...
			<td>Which center do you want to give Vaccine? </td>
			 <td><select id="center" name="center" value="<?php echo $n["center"]; ?>">
				...
				<tr>
                    <td align="left"><input type="submit" name="updatePublic" value="Update"></td>
